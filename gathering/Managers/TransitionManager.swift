...
final class TransitionManager: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let animator = UIViewPropertyAnimator(duration: duration, curve: .easeInOut) {
            ...
            snapshotEventImageView.frame = containerView.convert(CGRect(x: 0, y: 0, width: toViewController.view.width, height: toViewController.view.width), from: toViewController.headerImageView)

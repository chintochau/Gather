...
class EventOwnerCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        imageView.anchor(top: topAnchor, leading: leadingAnchor, bottom: bottomAnchor, trailing: nil,padding: .init(top: 0, left: 20, bottom: 0, right: 20),size: CGSize(width: iconSize, height: iconSize))
